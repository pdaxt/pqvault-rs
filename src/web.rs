...
use crate::models::{auto_categorize, mask_value, SecretEntry};
use crate::providers::{detect_provider, get_provider, AuthMethod};
use crate::smart::UsageTracker;
use crate::vault::{meta_file, open_vault, save_vault};

struct AppState {
    vault: Mutex<crate::models::VaultData>,
